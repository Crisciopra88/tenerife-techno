...
const UA = "Mozilla/5.0 (compatible; TenerifeTechnoBot/1.0)";
...
const SOURCES = [
  ...
  // LAS ROCAS / FARRA — biglietteria ufficiale su MuchoHype (piattaforma Ticket Tailor).
  // Legge l'elenco eventi e poi ogni scheda (nome, data, locale). Niente anti-bot: lettura diretta.
  { name:"Las Rocas / Farra (MuchoHype)", strategy:"tickettailor", url:"https://tickets.muchohype.com/events/muchohype", defaultPromoter:"farra", cat:"Club" },
